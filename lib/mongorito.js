...
;
  ...
  MongoritoModel = (function() {
    ...
    MongoritoModel._notFields = ['constructor', 'save', 'collectionName', 'create', 'fields', 'update', 'remove', 'beforeCreate', 'aroundCreate', 'afterCreate', 'beforeUpdate', 'aroundUpdate', 'afterUpdate'];

    MongoritoModel.prototype._isField = function(field) {
      if (field.substr(0, 1) === '_') return false;
    ...
    MongoritoModel.prototype.fields = function() {
      ...
      fields = {};
      for (field in this) {
        if (this._isField(field)) fields[field] = this[field];
      }
      return fields;
    };
